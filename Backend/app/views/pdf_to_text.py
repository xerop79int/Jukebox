...
def convert_image_to_text(image_file):
	# path = os.getcwd()
	# path_to_tesseract = path + '/tesseract.AppImage'
	# pytesseract.tesseract_cmd = './tesseract.AppImage'
...
def get_body(text):
	...
	try:
		...
		# elif ('[Verse 2]' in text):
		# 	find_verse2 = re.findall('(\W+\[Verse 2\])', text)[0]
		# 	body = text.split(find_verse2)
		# 	body_string = find_verse2 + '\n' + body[1]
		# elif ('[Verse 3]' in text):
		# 	find_verse3 = re.findall('(\W+\[Verse 3\])', text)[0]
		# 	body = text.split(find_verse3)
		# 	body_string = find_verse3 + '\n' + body[1]
		elif ('[Verse]' in text):
